defmodule BlogifyWeb.OwnerRegistrationLiveTest do
  ...
  describe "Registration page" do
    ...
    test "renders errors for invalid data", %{conn: conn} do
      ...
      result =
        ...
        |> render_change(owner: %{"email" => "with spaces", "password" => "too short"})
    ...
    test "renders errors for duplicated email", %{conn: conn} do
      ...
      result =
        ...
        |> form("#registration_form",
          owner: %{"email" => owner.email, "password" => "valid_password"}
        )
        |> render_submit()
